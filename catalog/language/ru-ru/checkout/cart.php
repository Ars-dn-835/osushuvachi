...
$_['text_cart_manager']        = 'Наш менеджер перезвонит, чтобы оформить заказ';
$_['cart_apply_for_credit'] = 'Оформить в кредит';
$_['text_cart_text_cust'] = 'Онлайн оформление кредита – решение за 5 минут.<br>Вы можете выбрать срок кредитования и ежемесячный<br> платеж самостоятельно';
$_['cart_title_order'] = 'Заказ';
$_['cart_text_ware'] = 'Товары';
$_['cart_text_discount'] = 'Скидка';
$_['cart_the_total_cost'] = 'Общая стоимость';
$_['cart_button_one_click'] = 'Заказать';
$_['text_cart_text_cust'] = 'Онлайн оформление кредита – решение за 5 минут.<br>
Вы можете выбрать срок кредитования и ежемесячный платеж самостоятельно';
