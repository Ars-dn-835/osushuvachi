...
class __TwigTemplate_8d0fe4aeafb45f5ba0cb48ac8af546dcd274cde8cd716ebbd9d1ab97bae37c18 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<script>
    \$(document).ready(function() {
        \$('#simplecheckout_button_confirm').on('click', function() {
            ...
            \$.ajax({
                url: 'index.php?route=checkout/simplecheckout_cart/validate',
                type: 'post',
                data: requestData,
                dataType: 'json',
                success: function(json) {
