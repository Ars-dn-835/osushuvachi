...
class __TwigTemplate_8ced360b242188357ad36b35f3150b47a502eaa9eecc9355c5bcbf8fa045bf21 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
            ...
            echo "\" class=\"btn btn-remove\"
                                        onclick=\"cart.remove('";
            // line 185
            echo twig_get_attribute($this->env, $this->source, $context["product"], "cart_id", [], "any", false, false, false, 185);
            echo "');\"><i class=\"fa fa-times-circle\"></i></button>
                            </div>
                        ";
        }
...
";
        ...
        echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "price", [], "any", false, false, false, 195);
        echo "</p>
...
";
        // line 199
        echo "                        ";
        if ((($context["modules"] ?? null) && twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 199), "get", [0 => "cartPanelsStatus"], "method", false, false, false, 199))) {
            // line 200
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["total"]) {
            ...
            // line 209
            echo twig_get_attribute($this->env, $this->source, $context["total"], "title", [], "any", false, false, false, 209);
            echo ":</strong></td>
                                        <td class=\"text-right\">";
            // line 210
