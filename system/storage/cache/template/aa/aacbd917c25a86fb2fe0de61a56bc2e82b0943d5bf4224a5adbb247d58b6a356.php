...
class __TwigTemplate_e0b4c62c6798a46ab7ccf2d1947f34c3e721165bd9fa24c8421ab578909fc71a extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"simplecheckout-block-content\">
        ...
        if ( !twig_test_empty(($context["payment_methods"] ?? null))) {
            ...
            if ((($context["display_type"] ?? null) == 2)) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["payment_method"]) {
                    // line 31
                    echo "                    <div class=\"paymant__metod__simple\">
                    <div class=\"radio\">
                        <label for=\"";
                    // line 33
...
<style>
    ...
    {
        return array (  268 => 65,  262 => 63,  259 => 62,  253 => 60,  250 => 59,  245 => 57,  240 => 56,  237 => 55,  231 => 54,  228 => 53,  219 => 51,  214 => 50,  212 => 49,  205 => 44,  197 => 41,  194 => 40,  191 => 39,  185 => 37,  183 => 36,  179 => 35,  165 => 34,  161 => 33,  157 => 31,  152 => 30,  149 => 29,  146 => 28,  143 => 27,  134 => 25,  129 => 24,  126 => 23,  120 => 21,  117 => 20,  115 => 19,  112 => 18,  106 => 17,  103 => 16,  100 => 15,  98 => 14,  83 => 13,  79 => 12,  71 => 11,  68 => 10,  65 => 9,  62 => 8,  60 => 7,  52 => 5,  46 => 3,  44 => 2,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("<div class=\"simplecheckout-block\" id=\"simplecheckout_payment\" {{ hide ? 'data-hide=\"true\"' : '' }} {{ display_error and has_error ? 'data-error=\"true\"' : '' }}>
    {% if display_header %}
    ...
    <div class=\"simplecheckout-block-content\">
        {% if payment_methods is not empty %}
            ...
            {% else %}
                {% for payment_method in payment_methods %}
                    <div class=\"paymant__metod__simple\">
                    <div class=\"radio\">
...
</style>", "default/template/checkout/simplecheckout_payment.twig", "");
    }
}
