...
class __TwigTemplate_0ab8f82e37b9372a2b0051d03bcc6c08c41ddfab91c324a722f141d7e9a64503 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
            ...
            echo "  
                            ...
                            <div style=\"display: flex;\">
                                <div>
                                    ";
            // line 149
            if (twig_get_attribute($this->env, $this->source, $context["product"], "thumb", [], "any", false, false, false, 149)) {
                // line 150
                echo "                                        <a href=\"";
                ...
                echo "\">
                                            <img  src=\"";
                // line 151
                echo twig_get_attribute($this->env, $this->source, $context["product"], "thumb", [], "any", false, false, false, 151);
                echo "\" alt=\"";
            ...
            echo "                                </div>
                                <div>
                                        <div class=\"product-sku\">
                                            <p>Код товару: ";
            // line 158
            echo twig_get_attribute($this->env, $this->source, $context["product"], "sku", [], "any", false, false, false, 158);
            echo "</p>
                                        </div>
                                    <h2>
                            ...
                            <div style=\"display: flex; align-items: center;\">
                                <div>
                                    <div style=\"display: flex;\" class=\"stepper\">
                                                    <button type=\"submit\" class=\"stepper-arrow stepper__minus btn-update\" v-on:click=\"updateCartItemQuantity(index, -1)\">
                                                        <svg height=\"1em\" viewBox=\"0 0 320 512\">
                                                            <path d=\"M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z\"/></svg></button>
            ...
            echo "\" size=\"1\" class=\"form-control\"/>
                                        <button type=\"submit\" class=\"stepper-arrow stepper__plus btn-update\" v-on:click=\"updateCartItemQuantity(index, 1)\">
                                            <svg height=\"1em\" viewBox=\"0 0 320 512\"><path d=\"M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z\"/></svg></button>
                                    </div>
                                </div>
                                <div>
            ...
            // line 182
            echo twig_get_attribute($this->env, $this->source, $context["product"], "total", [], "any", false, false, false, 182);
            echo "</p>
                                </div>
                            </div>
...
";
        ...
        echo "</span>
                ...
                <div style=\"display: flex; align-items: center;\" class=\"cart-bottom\"  id=\"accordion\">
        ...
        echo "                    </div>
                    ...
                    <div style=\"display: flex; align-items: center;\" class=\"cart-bottom\">
                    <div class=\"simple__buy__in__credit__cust\">
                        <div class=\"simple__buy__btn__cust\">
                            <a href=\"#\" class=\"custom__button__cart__in__credit__cust\">";
        // line 248
        echo ($context["cart_apply_for_credit"] ?? null);
        echo "</a>
                        </div>
                        <div class=\"simple__buy__text__cust\">";
        // line 250
        echo ($context["text_cart_text_cust"] ?? null);
        echo "</div>
                    </div>
                    </div>
                </div>
...
<script type=\"text/javascript\">
    ...
    {
        return array (  436 => 260,  431 => 258,  427 => 257,  417 => 250,  412 => 248,  405 => 243,  396 => 241,  392 => 240,  382 => 233,  375 => 230,  366 => 227,  363 => 226,  359 => 225,  355 => 224,  350 => 222,  344 => 219,  340 => 218,  335 => 215,  326 => 212,  322 => 211,  319 => 210,  315 => 209,  311 => 207,  304 => 204,  301 => 202,  298 => 201,  293 => 196,  286 => 190,  277 => 187,  273 => 186,  266 => 182,  262 => 181,  251 => 175,  239 => 166,  236 => 165,  232 => 163,  230 => 162,  224 => 161,  218 => 158,  213 => 155,  207 => 152,  201 => 151,  196 => 150,  194 => 149,  188 => 145,  184 => 144,  180 => 142,  177 => 140,  174 => 72,  171 => 70,  167 => 56,  161 => 54,  157 => 52,  151 => 51,  149 => 50,  144 => 49,  142 => 48,  137 => 47,  134 => 46,  131 => 45,  128 => 44,  125 => 43,  122 => 42,  119 => 41,  117 => 40,  112 => 39,  104 => 35,  101 => 34,  93 => 30,  90 => 29,  82 => 25,  80 => 24,  75 => 22,  71 => 20,  60 => 18,  56 => 17,  51 => 14,  47 => 10,  43 => 8,  41 => 7,  37 => 1,);
    }
...
{#                                <h2 class=\"title\">{{ text_next }}</h2>#}
                        ...
                        <div class=\"cart-total\">
                            <table class=\"table table-bordered\">
                                {% for total in totals %}
                                    <tr>
                                        <td class=\"\"\"><strong>{{ total.title }}:</strong></td>
            ...
            {% endfor %}
                ...
                <div style=\"display: flex; align-items: center;\" class=\"cart-bottom\"  id=\"accordion\">
                    <div class=\"panel-group\"> {% for module in modules %}
                            {{ module }}
                        {% endfor %}
                    </div>
                </div>
                    ...
                    <div class=\"simple__buy__in__credit__cust\">
                        <div class=\"simple__buy__btn__cust\">
                            <a href=\"#\" class=\"custom__button__cart__in__credit__cust\">{{ cart_apply_for_credit }}</a>
                        </div>
                        <div class=\"simple__buy__text__cust\">{{ text_cart_text_cust }}</div>
                    </div>
                    </div>
                </div>
