...
class __TwigTemplate_e75477cedce2f1b5af1b23f5616548a4d060fafb96f529a6bdefa67bdf22d1b6 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        // line 46
        if ((isset($context["sc_menus"]) || array_key_exists("sc_menus", $context))) {
            echo " ";
...
{% if (sc_menus is defined) %} {{ sc_menus }} {% endif %}
  <div id=\"stats\">
    <ul>
      <li>
