...
/* extension/payment/cod1.twig */
class __TwigTemplate_34d9aec51ceddc2add0878789a9bc1729a713430938e1bbaecd7f3c1ee5ccbb3 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"container-fluid\">
    ...
    ";
      ...
      <div class=\"panel-body\">
        ...
        echo "</span></label>
            <div class=\"col-sm-10\">
              <input type=\"text\" name=\"payment_cod1_total\" value=\"";
        // line 31
        echo ($context["payment_cod1_total"] ?? null);
        echo "\" placeholder=\"";
        echo ($context["entry_total"] ?? null);
        ...
        echo "</label>
            <div class=\"col-sm-10\">
              <select name=\"payment_cod1_order_status_id\" id=\"input-order-status\" class=\"form-control\">
                ";
        // line 38
        $context['_parent'] = $context;
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["order_status"]) {
            // line 39
            echo "                ";
            if ((twig_get_attribute($this->env, $this->source, $context["order_status"], "order_status_id", [], "any", false, false, false, 39) == ($context["payment_cod1_order_status_id"] ?? null))) {
                // line 40
                echo "                <option value=\"";
        ...
        echo "</label>
            <div class=\"col-sm-10\">
              <select name=\"payment_cod1_geo_zone_id\" id=\"input-geo-zone\" class=\"form-control\">
                <option value=\"0\">";
        // line 52
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["geo_zone"]) {
            // line 54
            echo "                ";
            if ((twig_get_attribute($this->env, $this->source, $context["geo_zone"], "geo_zone_id", [], "any", false, false, false, 54) == ($context["payment_cod1_geo_zone_id"] ?? null))) {
                // line 55
                echo "                <option value=\"";
        ...
        echo "</label>
            <div class=\"col-sm-10\">
              <select name=\"payment_cod1_status\" id=\"input-status\" class=\"form-control\">
                ";
        // line 67
        if (($context["payment_cod1_status"] ?? null)) {
            // line 68
        ...
        echo "</label>
            <div class=\"col-sm-10\">
              <input type=\"text\" name=\"payment_cod1_sort_order\" value=\"";
        // line 80
        echo ($context["payment_cod1_sort_order"] ?? null);
        echo "\" placeholder=\"";
        echo ($context["entry_sort_order"] ?? null);
...
";
    ...
    {
        return "extension/payment/cod1.twig";
    }
    ...
    {
        return new Source("", "extension/payment/cod1.twig", "");
    }
}
